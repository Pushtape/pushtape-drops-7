 ...
 */
function pushtape_wireframe_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['#submit'][] = 'pushtape_wireframe_theme_settings_submit';
  $form['#validate'][] = 'pushtape_wireframe_theme_settings_validate';
}

/**
 * Custom Validation Hook
 */
function pushtape_wireframe_theme_settings_validate($form, &$form_state) {
  // Handle file uploads.
 ...
 * Custom Submit Hook
 */
function pushtape_wireframe_theme_settings_submit($form, &$form_state) {
